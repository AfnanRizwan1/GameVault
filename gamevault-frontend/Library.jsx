...
import { FiBookOpen, FiPlay, FiStar, FiSearch } from 'react-icons/fi';
  ...
  return (
    <div className="library-page">
      <div className="library-header">
        <div>
          <h1 className="page-title"><FiBookOpen /> My Library</h1>
      ...
      {ownedGames.length === 0 ? (
        <div className="library-empty panel">
          <FiBookOpen size={60} className="lib-empty-icon" />
              ...
              <div key={game.id} className="lib-card panel">
                <div className="lib-card-cover" style={{ background: `linear-gradient(135deg, ${colors[0]}, ${colors[1]})` }}>
                  ...
                  <div className="lib-card-overlay">
                    <Link to={`/game/${game.id}`} className="lib-play-btn">
                      <FiPlay /> View Details
                    </Link>
                  </div>
                </div>
                <div className="lib-card-info">
                  ...
                  <div className="lib-card-meta">
                    ...
                    <span className="lib-rating">
                      <FiStar /> {game.rating.toFixed(1)}
                    </span>
                  </div>
