      ...
      <div className="navbar-inner">
        ...
        <div className="navbar-left">
          ...
          <Link to={isAdmin ? '/admin' : '/'} className="navbar-brand">
            <Icon name="sports_esports" className="brand-icon" />
            ...
            <div className="user-menu-wrap" ref={userMenuRef}>
              ...
              {userMenuOpen && (
                <div className="dropdown-menu">
                  ...
                  {isDeveloper && <Link to="/developer" className="dropdown-item" onClick={() => setUserMenuOpen(false)}><Icon name="inventory_2" size={16} /> Dev Hub</Link>}
