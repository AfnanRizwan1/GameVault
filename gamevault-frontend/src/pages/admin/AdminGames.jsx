...
const DEFAULT_GAME = { title: '', genre: 'Action', price: '', description: '', developer: '', tags: '' };
  ...
  const handleAddGame = async (e) => {
    ...
    try {
      const data = await adminApi.createGame({
        ...
        description: newGame.description || `${newGame.title} is available on GameVault.`,
        developer: newGame.developer || 'GameVault Studios',
  ...
  return (
    <div className="admin-page">
      ...
      <div className="ag-table-wrap panel">
        ...
        {filtered.length === 0 && !loading && <div className="ag-empty"><p>No games found. Try adjusting filters.</p></div>}
      </div>
