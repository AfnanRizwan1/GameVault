    ...
    <div className="admin-page">
      ...
      <div className="admin-content-grid">
        <div className="admin-panel">
          <div className="admin-panel-header"><h2><Icon name="trending_up" size={18} /> Top Selling Games</h2><Link to="/admin/games" className="admin-panel-link">View All <Icon name="arrow_forward" size={14} /></Link></div>
        ...
        <div className="admin-right-col">
          <div className="admin-panel">
            ...
            <div className="quick-actions-grid">
              <Link to="/admin/games" className="quick-action-btn"><Icon name="apps" size={20} /><span>All Games</span></Link>
              <Link to="/admin/users" className="quick-action-btn"><Icon name="group" size={20} /><span>Users</span></Link>
              <Link to="/admin/games" className="quick-action-btn accent"><Icon name="inventory_2" size={20} /><span>Add Game</span></Link>
