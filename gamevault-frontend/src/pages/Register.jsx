    ...
    <div className="auth-page">
      ...
      <div className="auth-card auth-card-wide">
        <div className="auth-logo">
          <Icon name="sports_esports" className="auth-logo-icon" />
          <h1>GameVault</h1>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="auth-field">
            ...
            <div className="role-cards">
              {[
                { value: 'customer', label: 'Player', desc: 'Browse & purchase games' },
                { value: 'developer', label: 'Developer', desc: 'Publish & sell your games' },
              ].map(r => (
