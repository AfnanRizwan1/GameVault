        ...
        <div className="profile-card panel">
          ...
          <div className="profile-details">
            ...
            <div className="profile-detail">
              ...
              <div><span className="detail-label">Games Owned</span><span className="detail-value">{ownedGames.length}</span></div>
            </div>
          </div>
        </div>
        <div className="profile-right">
          <div className="profile-stats">
            <div className="stat-card">
              <div className="stat-icon"><Icon name="sports_esports" size={28} /></div>
          ...
          {ownedGames.length > 0 && (
            <div className="panel">
              <h3 className="profile-section-title"><Icon name="library_books" size={18} /> Recent Games</h3>
