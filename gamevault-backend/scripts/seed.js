...
const seed = async () => {
  ...
  const [customer, developer, admin] = await User.create([
    ...
    {
      username: "Sam Chen",
      email: "dev@gamevault.com",
      password: "password123",
      role: "developer",
      profile: { fullName: "NovaStar Studios" },
    },
    {
      username: "Admin User",
  ...
  fs.writeFileSync(
    demoFilePath,
    "This is a GameVault demo download file for seeded catalog games.\n"
  );
  ...
  const games = await Game.create(
    mockGames.map((game, index) => ({
      ...
      developerName: index < 3 ? "NovaStar Studios" : game.developer,
      price: game.price,
      category: game.genre,
  ...
  console.log("Customer: user@gamevault.com / password123");
  console.log("Developer: dev@gamevault.com / password123");
  console.log("Admin: admin@gamevault.com / password123");
